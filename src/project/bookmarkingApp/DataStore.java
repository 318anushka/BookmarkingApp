...
import project.bookmarkingApp.constants.BookGenre;
import project.bookmarkingApp.constants.Gender;
import project.bookmarkingApp.constants.MovieGenre;
import project.bookmarkingApp.constants.UserType;
...
public class DataStore {
    ...
    private static Bookmark[][] bookmark = new Bookmark[BOOKMARK_TYPES_COUNT][BOOKMARK_COUNT_PER_TYPE];
    ...
    public static void loadUsers(){
        ...
        users[3] = UserManager.getInstance().createUser(1003 ,	"user3@semanticsquare.com" ,	"test" ,	"Sara" , 	"M" , Gender.FEMALE  , UserType.CHIEF_EDITOR);
        users[4] = UserManager.getInstance().createUser(1004 ,	"user4@semanticsquare.com" ,	"test" ,	"Rachael" , 	"M" , Gender.FEMALE  , UserType.EDITOR);
    ...
    public static void loadWebLinks() {
        ...
        bookmark[0][3] = BookmarkManager.getInstance().createWebLink(2003 , "NIO tutorial by Greg Travis" , "http://cs.brown.edu/courses/cs161/papers/j-nio-ltr.pdf" , "http://cs.brown.edu"	);
    ...
    private static void loadMovies() {
        bookmark[1][0] = BookmarkManager.getInstance().createMovie(3000 ,	"Citizen Kane" ,	1941 , new String[]{"Orson Welles", "Joseph Cotten"}, 	new String[] {"Orson Welles"} , MovieGenre.CLASSICS , 8.5	);
        ...
        bookmark[1][2] = BookmarkManager.getInstance().createMovie(3002 ,	"A Touch of Greatness" ,	2004 , new String[]{"Albert Cullum"} , new String[]{"Leslie Sullivan"} , 	MovieGenre.DOCUMENTARIES ,	7.3);
    ...
    private static void loadBooks(){
        ...
        bookmark[2][2] = BookmarkManager.getInstance().createBook(4002 ,	"Light From Many Lamps" , 	1988 ,	"Touchstone" , new String[]{"Lillian Eichler Watson"} ,	BookGenre.PHILOSOPHY ,	5.0	);
        ...
        bookmark[2][4] = BookmarkManager.getInstance().createBook(4004 , "Effective Java Programming Language Guide" ,	2007 ," PrenticeHall" ,	new String[]{"Joshua" , "Bloch"} ,	BookGenre.TECHNICAL ,	4.9);
    }

    public static void add(UserBookmark userBookmark) {
        userBookmarks[index] = userBookmark;
        index++;
